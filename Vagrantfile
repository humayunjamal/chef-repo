...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "humayunjamal-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/hj-training"
  #   chef.validation_client_name = "hj-training-validator"
  #   chef.validation_key_path = ".chef/hj-training-validator.pem"
  # end
end
